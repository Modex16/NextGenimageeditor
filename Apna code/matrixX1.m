...
clear;
for j=0:2
    d=fullfile('F:\workshop related\Mosaic16\dataset1',num2str(j));
    cd(d);
e=dir(fullfile('F:\workshop related\Mosaic16\dataset1',num2str(j),'*.png'));
